...
Pipeline de retraitement audio pour fichiers WAV issus de Suno AI :
...
vérifiées séparément du hosting AU réel (qui requiert AVFoundation/
AudioToolbox via PyObjC, donc macOS).
"""
